...
// JNWLabel
#define COCOAPODS_POD_AVAILABLE_JNWLabel
#define COCOAPODS_VERSION_MAJOR_JNWLabel 1
#define COCOAPODS_VERSION_MINOR_JNWLabel 0
#define COCOAPODS_VERSION_PATCH_JNWLabel 0
